...
function getSuggestion() {
	...
	var str = $('#usr').val();
	xhttp.open("GET", "/WebSrcEngine/WebSrcController?act=prefix&prefix=" + str, true);
	xhttp.send();
...
function getTopUrls() {
	...
	var str = $('#usr').val();
	xhttp.open("GET", "/WebSrcEngine/WebSrcController?act=getTopUrl&prefix=" + str, true);
	xhttp.send();
...
function getrecommendedWord() {
	...
	var str = $('#usr').val();
	xhttp.open("GET", "/WebSrcEngine/WebSrcController?act=getCorWord&prefix=" + str, true);
	xhttp.send();
